...
"""
valued_stock_PBR.py
Low PBR + Low Debt Ratio 전략의 BackTesting
"""
...
def calc_yield(**args):
    ...
    """
    lowPBR_with_lowDebt_list: The Basket (Low PBR with Low Debt List)
    PBR_list: PBR 값
    debt_list: debt 값
    name_list: 종목명
    buy_price: 매수 가격
...
file_name = './results_PER_' + str(PBR_upper_threshold) + '_' + str(PBR_lower_threshold) + '_' + str(upper_yield_limit) + '_' + str(lower_yield_limit) + '.xlsx'
